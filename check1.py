...
icon = pygame.image.load('red.jpg')   # add icon
pygame.display.set_icon(icon)

clock = pygame.time.Clock()

carImg = pygame.image.load("car.png") #load the car image
car2Img = pygame.image.load("cars.png")
bgImg = pygame.image.load("rd.png")
crash_img = pygame.image.load("crash.png")
bgsImg = pygame.image.load("bg.png")
